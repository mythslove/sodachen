...
{
	import com.asframe.lang.IClass;
	 ...
	 * @author sodaChen
	 */
	public class AbstractLoader extends UrlVersion implements ILoader,IClass
	{
		/** 日志输出对象 **/
		...
		public function load(url:*, sucessResult:Function = null, target:* = null, loading:ILoading = null):void
		{
			...
			loadData.url = url;
			loadData.loader = this;
			loadData.target = target;
			startLoad(new URLRequest(getFullUrl(url)));
		}
		/**
		 * 添加loder的相关事件 
