...
package com.asframe.load.multi
{
	...
	public interface IMultiLoader extends ILoader
	{
		 ...
		 * 
		 */			
		function addDefaultOneFun(defaultOneSucess:Function,defaultOneFail:Function = null):void;
		 ...
		 * 
		 */			
		function setOneResult(oneSucessFun:Function,oneFailFun:Function = null):void;
		/**
		 * 继续加载 
		 */		
		function start():void;
		 ...
		 * @param complete 回调函数
		 */		
		function startLoadNext(url:String,target:*,complete:Function,loading:ILoading):void;
		/**
		 * 设置下一个加载器的解析器 
		 * @param nextLoader
		 * 
